...
import com.isoceles.hypothenus.gym.domain.repository.IGymQueries;
...
public class IGymQueriesImpl implements IGymQueries {
	...
	public IGymQueriesImpl(MongoTemplate mongoTemplate) {
	...
	public List<GymSearchResult> searchAutocomplete(String criteria) {
		...
		aggregationResults.forEach(doc -> logger.debug(doc.getGymId()));
