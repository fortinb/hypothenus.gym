package com.iso.hypo.common.application.usecase;
...
/**
 * Application-layer output port for identity-provider operations.
 * The implementation lives in the infrastructure layer.
 * NOTE: MS Graph SDK types in this interface will be replaced by
 * application-owned types when Violation 6 is addressed.
 */
