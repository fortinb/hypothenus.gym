...
public class FinanceMonerisPortAdapter implements PaymentProviderPort {
	...
	@Override
	public ReceiptRef verify(PaymentProviderConfigurationEntry config, CreditCardRef creditCard) {
	...
	@Override
	public ReceiptRef register(PaymentProviderConfigurationEntry config, CreditCardRef creditCard) {
		String crypt = "7";
		boolean status_check = false;
	...
	@Override
	public ReceiptRef delete(PaymentProviderConfigurationEntry config, CreditCardRef creditCard) {
		boolean status_check = false;
