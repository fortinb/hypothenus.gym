...
import com.iso.hypo.finance.infrastructure.port.mapper.FinanceMemberRefMapper;
...
@Component
public class FinanceMemberServicePortAdapter implements MemberServicePort {

	private static final Logger logger = LoggerFactory.getLogger(FinanceMemberServicePortAdapter.class);

	private final MemberQueryService memberQueryService;
	private final FinanceMemberRefMapper memberRefMapper;

	@SuppressWarnings("unused")
	private final RequestContext requestContext;

	public FinanceMemberServicePortAdapter(MemberQueryService memberQueryService, FinanceMemberRefMapper memberRefMapper,
