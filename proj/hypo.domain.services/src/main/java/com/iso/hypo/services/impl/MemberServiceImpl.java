...
public class MemberServiceImpl implements MemberService {
    ...
    public MemberServiceImpl(MemberMapper memberMapper, MemberRepository memberRepository, ApplicationEventPublisher eventPublisher, BrandQueryService brandQueryService, RequestContext requestContext) {
    ...
    public MemberDto create(MemberDto memberDto, String password) throws MemberException {
        try {
            ...
            if (e instanceof BrandException) {
                throw new MemberException(requestContext.getTrackingNumber(), MemberException.BRAND_NOT_FOUND, "Brand not found");
            }
    ...
    public MemberDto update(MemberDto memberDto) throws MemberException {
        try {
            ...
            logger.error("Error - brandUuid={}, memberUuid={}", memberDto != null ? memberDto.getBrandUuid() : null, memberDto != null ? memberDto.getUuid() : null, e);
